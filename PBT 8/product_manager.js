...
// Output: 9 sản phẩm (loại iPad Air vì stock = 0)

console.log("\n=== PHONES 15-25 TRIỆU ===");
console.log(filterProducts(products, "phone", 15000000, 25000000));
// Output: [iPhone 16, Samsung S24, Pixel 9]

console.log("\n=== SORTED BY PRICE (ASC) ===");
console.log(sortByPrice(products, "asc").map(p => ({ name: p.name, price: p.price })));

console.log("\n=== SORTED BY PRICE (DESC) ===");
console.log(sortByPrice(products, "desc").map(p => ({ name: p.name, price: p.price })));
...
console.log("\n=== FORMATTED PRODUCT LIST (First 5) ===");
console.log(formatProductList(products).slice(0, 5));
// Output:
// [
//   { name: 'iPhone 16', formattedPrice: '25.990.000đ' },
//   { name: 'MacBook Pro', formattedPrice: '45.990.000đ' },
//   ...
// ]

console.log("\n=== AVERAGE RATING ===");
console.log("Average rating: " + averageRating(products) + " / 5.0");
// Output: Average rating: 4.43 / 5.0

console.log("\n=== SEARCH PRODUCTS ===");
console.log("Search 'iphone':");
console.log(searchProducts(products, "iphone"));
// Output: [{ id: 1, name: "iPhone 16", ... }]

console.log("\nSearch 'pro':");
console.log(searchProducts(products, "pro"));
// Output: [MacBook Pro, AirPods Pro]

console.log("\nSearch 'pad':");
console.log(searchProducts(products, "pad"));
// Output: [iPad Air, Xiaomi Pad 6]
